"use strict";
(self["webpackChunkcompany_portal"] = self["webpackChunkcompany_portal"] || []).push([["common"],{

/***/ 376:
/*!*****************************************************!*\
  !*** ./src/app/services/departments-api.service.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DepartmentsApiService: () => (/* binding */ DepartmentsApiService)
/* harmony export */ });
...
let DepartmentsApiService = /*#__PURE__*/(() => {
  class DepartmentsApiService {
    ...
    listDepartments(tenantId) {
      return this.http.get(`${this.baseUrl}/admin/departments?tenant_id=${encodeURIComponent(tenantId)}`);
    }
    createDepartment(payload) {
      return this.http.post(`${this.baseUrl}/admin/departments`, {
    ...
    updateDepartment(payload) {
      return this.http.put(`${this.baseUrl}/admin/departments/${payload.departmentId}`, {
        tenant_id: payload.tenantId,
        name: payload.name,
        description: payload.description,
        head: payload.head || '',
    ...
    deleteDepartment(departmentId, tenantId) {
      return this.http.delete(`${this.baseUrl}/admin/departments/${departmentId}?tenant_id=${encodeURIComponent(tenantId)}`);
    }
    static {
      this.ɵfac = function DepartmentsApiService_Factory(t) {
        return new (t || DepartmentsApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
      };
    }
    static {
      this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: DepartmentsApiService,
        factory: DepartmentsApiService.ɵfac
      });
    }
  }
  return DepartmentsApiService;
})();
...
/***/ 4686:
/*!***********************************************!*\
  !*** ./src/app/services/roles-api.service.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   RolesApiService: () => (/* binding */ RolesApiService)
/* harmony export */ });
/* harmony import */ var _environments_environment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../environments/environment */ 5312);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ 7580);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ 6443);
...
let RolesApiService = /*#__PURE__*/(() => {
  class RolesApiService {
    ...
    listRoles(tenantId) {
      return this.http.get(`${this.baseUrl}/admin/roles?tenant_id=${encodeURIComponent(tenantId)}`);
    }
    createRole(payload) {
    ...
    updateRole(payload) {
      return this.http.put(`${this.baseUrl}/admin/roles/${payload.roleId}`, {
        tenant_id: payload.tenantId,
        name: payload.name,
        description: payload.description,
        access_level: payload.accessLevel,
    ...
    deleteRole(roleId, tenantId) {
      return this.http.delete(`${this.baseUrl}/admin/roles/${roleId}?tenant_id=${encodeURIComponent(tenantId)}`);
    }
    static {
      this.ɵfac = function RolesApiService_Factory(t) {
        return new (t || RolesApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient));
      };
    }
    static {
      this.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
        token: RolesApiService,
        factory: RolesApiService.ɵfac
      });
    }
  }
...
/* harmony import */ var _haptic_554688a5_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./haptic-554688a5.js */ 1416);
/* harmony import */ var _index_2cf77112_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-2cf77112.js */ 9654);
/*!
...
/* harmony import */ var _helpers_be245865_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers-be245865.js */ 2641);
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_corpouslearning_ionic_company_portal_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
...
const createKeyboardController = /*#__PURE__*/function () {
  var _ref = (0,_var_www_html_corpouslearning_ionic_company_portal_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardChangeCallback) {
    ...
    const init = /*#__PURE__*/function () {
      var _ref2 = (0,_var_www_html_corpouslearning_ionic_company_portal_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const createLockController = () => {
  ...
  const lock = /*#__PURE__*/function () {
    var _ref = (0,_var_www_html_corpouslearning_ionic_company_portal_ionic_app_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const p = waitPromise;
      let resolve;
...
/* harmony export */ });
/* harmony import */ var _helpers_be245865_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers-be245865.js */ 2641);
/* harmony import */ var _dir_babeabeb_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dir-babeabeb.js */ 7280);
/* harmony import */ var _index_2cf77112_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-2cf77112.js */ 9654);
/* harmony import */ var _gesture_controller_1bf57181_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gesture-controller-1bf57181.js */ 5216);
/*!
 * (C) Ionic http://ionicframework.com - MIT License
 */
